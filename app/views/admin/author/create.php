        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title fw-semibold mb-4">Thêm tác giả mới</h5>
                            <div class="card">
                                <div class="card-body">
                                    <?php 
                                    ...
                                    <?php endif; ?>
                                    <form method="post" action="/admin/saveauthor">
                                        <div class="mb-3">
                                            <label class="form-label">Tên tác giả</label>
                                            <input type="text" class="form-control" id="name" name="name" placeholder="Nhập tên tác giả">
                                        </div>
