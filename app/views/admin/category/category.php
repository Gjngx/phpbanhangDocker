                    ...
                    <tbody>
                      ...
                      while ($row = $categories->fetch(PDO::FETCH_ASSOC)) : ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="/admin/updatecategory/<?php echo $row['id']; ?>" class="btn btn-warning">Cập nhật</a>
                            <?php if (isset($_SESSION['user_idrole']) && $_SESSION['user_idrole'] === 1) : ?>
                              <a href="/admin/deletecatagory/<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Xóa thể loại <?php echo $row['name'] ?> thì toàn bộ sách thuộc thể loại <?php echo $row['name'] ?> sẽ bị xóa! Bạn có chắc xóa thể loại <?php echo $row['name'] ?> không?')">Xóa thể loại</a>
                            <?php endif; ?>
                          </td>
                        </tr>
                      <?php
