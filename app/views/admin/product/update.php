                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php if (!empty($product['image'])) : ?>
                                        <img src="/public/images/products/<?php echo $product['image']; ?>" alt="Current Image" class="img-thumbnail" style="max-width: 200px;">
                                    <?php endif; ?>
                                    <form method="post" action="/admin/saveupdateproduct/<?php echo $product['id']; ?>" enctype="multipart/form-data">
                                        <div class="mb-3">
